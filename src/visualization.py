"""
visualization.py — Visualisasi Graf dan Hasil Benchmark
=========================================================
Modul ini menyediakan fungsi untuk:
1. Visualisasi graf dengan jalur terpendek (networkx + matplotlib)
2. Grafik perbandingan performa ketiga heap

Digunakan untuk video demo dan laporan proyek.
"""

import matplotlib.pyplot as plt
import matplotlib.patches as mpatches
import networkx as nx
from src.djikstra import reconstruct_path, dijkstra_basic, dijkstra_binary_heap, dijkstra_fibonacci_heap, dijkstra_postorder_heap
...
def compare_all_heaps_on_graph(graph, source: int = 0, target: int = None):
    """
    Tampilkan 3 visualisasi (satu per heap) secara berdampingan.
    """
...
def plot_benchmark_results(benchmark_data: list, metric: str = "avg_time_ms"):
    """
    Buat grafik perbandingan performa ketiga heap.

    Args:
        benchmark_data : hasil dari run_scalability_benchmark()
        metric         : "avg_time_ms", "avg_operations", atau "throughput"
    """
    metric_labels = {
