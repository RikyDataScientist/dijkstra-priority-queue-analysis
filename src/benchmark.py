...
performa ketiga implementasi Dijkstra pada berbagai ukuran graf.
...
from src.djikstra import dijkstra_basic, dijkstra_binary_heap, dijkstra_fibonacci_heap, dijkstra_postorder_heap, verify_results
...
def run_single_benchmark(graph: Graph, source: int = 0,
    ...
    Returns:
        dict berisi hasil benchmark untuk ketiga heap
    """
    results = {
